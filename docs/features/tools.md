...
<div class="mzk-card">
  <h3>💰 Mizuki 25时经济</h3>
  <p>
    全图片化养成经济系统，包含签到打工、PK红包、农场宠物、股票卡牌等丰富玩法。
  </p>
  <p>
    <a href="/features/economy" style="color:var(--vp-c-brand-1); font-weight:bold;">👉 查看完整经济系统指令手册</a>
  </p>
  <p>
...
<div class="mzk-card">
  <h3>📺 B站动态订阅</h3>
  <p>支持自动推送官方最新 B 站动态至群聊，<strong>目前需提供群号并联系管理员手动添加。</strong></p>
...
<div class="cmd-card">
  ...
  <span class="cmd-desc">每日签到获取基础资金</span>
</div>

<div class="cmd-card">
  <span class="cmd-pill">打工</span>
  <span class="cmd-desc">赚取额外资金</span>
</div>

<div class="cmd-card">
  <span class="cmd-pill">发送 mzk</span>
  <span class="cmd-desc">随机发送一张 mzk 文件夹的表情</span>
</div>

<div class="cmd-card">
  <span class="cmd-pill">经济商城</span>
  <span class="cmd-desc">浏览可购买的物品</span>
</div>

<div class="cmd-card">
  <span class="cmd-pill">表情帮助</span>
  <span class="cmd-desc">查看表情系统帮助</span>
</div>

<div class="cmd-card">
  <span class="cmd-pill">看所有 mzk</span>
  <span class="cmd-desc">生成九宫格预览</span>
</div>
