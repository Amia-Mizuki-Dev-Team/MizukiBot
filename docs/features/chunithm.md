...
<div class="cmd-card">
  <span class="cmd-pill">chu b30</span>
  <span class="cmd-desc">查询个人 B30 成绩与总 Rating</span>
</div>

<div class="cmd-card">
  <span class="cmd-pill">chu 祈愿</span>
  <span class="cmd-desc">查询歌曲 ID</span>
</div>

<div class="cmd-card">
  <span class="cmd-pill">chuinfo 1145</span>
  <span class="cmd-desc">查询歌曲基本信息</span>
</div>

<div class="cmd-card">
  <span class="cmd-pill">chuchart 1145ult</span>
  <span class="cmd-desc">查询 Ultima 难度谱面</span>
</div>
