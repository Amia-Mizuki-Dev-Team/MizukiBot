...
<div class="mzk-card mzk-card--red">
  <h3>2026.7 | HongXing 7月服务与产品调整公告</h3>
  <p>本次公告涉及服务下线、产品发布、旧版本生命周期、用户补偿、开发计划及基础设施调整。相关安排仍可能根据实际运行情况进行修订，后续变化将通过正式渠道说明。</p>

  <h4>一、NF 系列服务调整</h4>
  <ul>
    <li>计划于 <strong>2026 年 8 月 1 日</strong>停止 NF1 与 NF2 游戏服务，并同步下架 Earth DLC。</li>
    <li>相关 Store 商城将在服务停止前关闭；原负责人员将根据实际情况调整至其他开发部门。</li>
    <li>仍在使用相关服务的用户应提前完成必要的数据备份与迁移。</li>
  </ul>

  <h4>二、HongXing Nano Lab 发布计划</h4>
  <ul>
    <li>HongXing Nano Lab 计划于 <strong>2026 年 7 月 30 日</strong>发布，属于 AuthLit Lite 系列，主要面向资源相对有限的部署环境。</li>
    <li>在现阶段测试条件下，内存占用相较现有方案降低约 20%；实际效果可能因硬件、部署方式和负载不同而有所差异。</li>
    <li>Nano Lab 支持侧载固件方式部署，但仍需通过联网证书完成授权验证，同时加强激活验证机制。</li>
    <li>系统底层已进行精简，并内置基于 Linux 修改与适配的 HongXingOS 5。经多轮 Benchmark 与兼容性测试，目前达到阶段性稳定标准。</li>
    <li>当前已完成 Intel 与 AMD 平台的基础测试；ARM 平台暂不在本次支持范围内。</li>
  </ul>

  <h4>三、HongXing AuthLit 5 发布</h4>
  <ul>
    <li>经过多轮内部测试与问题修正，HongXing AuthLit 5 已达到现阶段发布标准。</li>
    <li>在 AuthLit 4 基础上进一步完善安全防护、主动干预和攻击预警能力。</li>
    <li>新增多用户身份统一管理、多实例管理、多层级权限管理、用户操作日志、防护操作日志、终端管理及多模式防火墙管理。</li>
    <li>新增 SSH 管理与远程管理能力。相关功能仍将根据实际运行情况和安全反馈持续调整。</li>
  </ul>

  <h4>四、旧版本生命周期调整</h4>
  <ul>
    <li>HongXing 3、HongXing 3.1 与 HongXing 4 已进入产品生命周期第四阶段，并停止常规功能更新。</li>
    <li>上述版本的最终更新代码统一为 <code>26J3</code>。</li>
    <li>后续仍将提供必要的系统升级渠道，帮助符合条件的用户迁移至 HongXingOS 5。</li>
  </ul>

  <h4>五、关于 2026 年 7 月重大事件的处理</h4>
  <ul>
    <li>对于事件及其对用户造成的影响，HongXing 表示歉意，并将继续开展内部调查与整改。</li>
    <li>涉事员工将被停职处理。</li>
    <li>所有仍在订阅 AuthLit 系列服务的用户将获赠三个月使用时间。</li>
    <li>符合条件且再次续订的用户将获得一次八折续订优惠；具体范围、领取方式和有效期限以后续通知为准。</li>
  </ul>

  <h4>六、部分项目开发计划调整</h4>
  <ul>
    <li>受事件影响及资源重新分配，部分项目已暂停开发，包括但不限于 HongXingOS 7。</li>
    <li>HongXingOS 7 的原定发布时间相应推迟，目前暂不公布新的预计发布日期。</li>
    <li>待项目资源、基础设施与内部管理恢复稳定后，将重新评估并公布后续计划。</li>
  </ul>

  <h4>七、机房与服务资源调整</h4>
  <ul>
    <li>由于苏州机房已无充足额外资源，已于 <strong>2026 年 7 月 5 日</strong>停止部分海外服务，Bot 一号服务器目前也已停止运行。</li>
    <li>南京机房将对部分服务实施带宽和流量限制，以控制运营成本并优先保障核心业务。</li>
    <li>苏州机房已停止为部分第三方服务提供托管，相关服务将根据实际情况迁移、终止或另行协商。</li>
    <li>上述调整可能对部分服务的访问速度、可用性或响应时间产生影响。</li>
  </ul>

  <h4>八、Fabs AI 内测进展</h4>
  <ul>
    <li>Fabs AI 目前已用于部分更新流程及系统底层开发工作。</li>
    <li>在已完成的七轮测试中，整体表现基本符合预期，但在细节处理、稳定性与复杂场景适配方面仍存在问题。</li>
    <li>计划于 <strong>2026 年 8 月</strong>面向部分用户开展小范围内测，具体参与条件、测试范围和反馈方式将在后续公告中说明。</li>
    <li>Fabs AI 目前仍处于测试阶段，不建议用于对稳定性要求较高的正式生产环境。</li>
  </ul>
</div>
