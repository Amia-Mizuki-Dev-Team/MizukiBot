...
<div class="custom-card" style="background: var(--vp-c-bg-soft); border-left: 5px solid #b2ed1d; padding: 20px; border-radius: 12px; margin-bottom: 25px;  text-align: left;">
  <h3 style="margin-top: 0; color: #b2ed1d;  text-align: left;">2026.5.30 | 开发组团队调整</h3>
  
  <h4 style="color: #b2ed1d; margin-top: 15px; font-size: 15px;  text-align: left;">一、人事调整</h4>
  <ul style="margin: 5px 0 15px 20px; font-size: 14px; opacity: 0.9; line-height: 1.8; text-align: left;">
    <li><strong>暂停工作</strong>：因学业繁忙，"HX-Wrdzgzs" "MC_FanBuFan"暂停开发工作。</li>
  </ul>

  <h4 style="color: #b2ed1d; margin-top: 15px; font-size: 15px;">二、维护信息</h4>
  <ul style="margin: 5px 0 15px 20px; font-size: 14px; opacity: 0.9; line-height: 1.8; text-align: left;">
    <li><strong>维护降级</strong>：Bot开发工作暂停，仅进行最低等级功能维护。</li>
  </ul>
</div>
