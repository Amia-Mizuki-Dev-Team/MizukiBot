---
title: 开发团队
description: Amia_晓山瑞希维护团队、技术支持、数据支持、软硬件支持和项目生态信息。
---
...
<div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px; max-width: 620px; margin: 0 auto; align-items: stretch;">
  ...
  <div class="mzk-dev-card" style="width: 100%; min-width: 0; box-sizing: border-box;">
    ...
    <details style="font-size: 12px; opacity: 0.8;"><summary>介绍</summary><p>社区秩序维护<br>后勤调度与管理</p></details>
  </div>
</div>
</div>
<br>
...
<div class="support-grid support-grid--compact">
  ...
  <a href="/projects/amia-plugin-maimaidx" class="support-card">
    <div class="support-info">
      <strong>舞萌 DX</strong>
      <span>查分、B50 / AP50、成绩分析与相关插件</span>
    </div>
  </a>

  <a href="/projects/amia-plugin-pjskhelp" class="support-card">
    <div class="support-info">
      <strong>PJSK</strong>
  ...
  <a href="/projects/amia-plugin-qbind" class="support-card">
    <div class="support-info">
      <strong>身份与协议</strong>
      <span>QQ 官方机器人真实 QQ 映射与身份绑定基础设施</span>
    </div>
  </a>

  <a href="/projects/mizuki-sync" class="support-card">
    <div class="support-info">
...
<div style="font-size: 0.9rem; opacity: 0.8; background: var(--vp-c-bg-soft); padding: 15px; border-radius: 8px; border-left: 3px solid #666;">
  ...
  软硬件与基础设施由 <strong>HongXing (江苏) 技术团队</strong> 支持
</div>
