...
<div class="mzk-card mzk-card--purple">
  <h3>4. 触发指令</h3>
  <p>完成权限配置后，可以发送 <code>帮助</code>、<code>个人信息</code>、<code>PJSK</code>、<code>经济帮助</code> 等指令。</p>
  <div class="mzk-alert">
    <strong>触发说明：</strong>请直接发送指令文本，无需 @机器人。部分功能在 @机器人时可能无法正确识别。
  </div>
</div>
...
| 页面 | 说明 |
| :--- | :--- |
| [PJSK 专项功能](/features/pjsk) | Project Sekai 查分、查榜、绑定、卡牌、歌曲和 MySekai 功能。 |
| [舞萌 DX 专项](/features/maimai) | 舞萌 DX 成绩查询、查歌、成绩同步和服务器状态。 |
