...
这里收录与 Amia_晓山瑞希及开发团队保持友链交换或长期交流的网站。

<ul class="friend-grid">
  <li class="friend-item">
    <a
      href="https://mzyyun.com/"
      target="_blank"
      rel="noopener noreferrer"
      class="mzk-card friend-card"
    ...
    >
      ...
      <span class="friend-content">
        <strong class="friend-name">墨染辉夜</strong>
        <span class="friend-description">分享技术、日常与思考</span>
        <span class="friend-domain" aria-hidden="true">mzyyun.com</span>
      </span>
    </a>
  </li>
</ul>
...
- 网站能够通过 HTTPS 正常访问；
- 内容合法，不包含大量采集、恶意跳转或侵入式广告；
- 已在对方网站添加本站链接；
- 建议与技术、开源、个人开发、音游或相关社区有关；
- 网站长期失效时可能暂时移除。
